...
Recaptcha.prototype.init = function (site_key, secret_key, options) {
  ...
  this.options = options || { checkremoteip: false };
...
Recaptcha.prototype.render = function () {
  ...
  var tpl = '<script src="//' + this.api.host + this.api.script + query_string + '" async defer></script>' + '<div class="g-recaptcha" data-sitekey="' + this.site_key + '"' + captcha_attr + '></div>';
  return tpl;
};
